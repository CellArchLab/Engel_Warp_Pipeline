...
EER_NGROUPS="16"                    # 1 for TIFF. Otherwise frames per EER stack. Negative number for number of EER groups (same as FmInt in AreTomo3)
GAIN_FLIP_Y="false"                 # EER true, TIFF false
